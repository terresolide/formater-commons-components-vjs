...
export default {
    ...
    created: function(){
        ...
        document.addEventListener('formaterResetEvent', this.resetEventListener);
        this.searchEventListener = this.handleSearch.bind(this) 
        document.addEventListener('formaterSearchEvent', this.searchEventListener);
        this.aerisThemeListener = this.handleTheme.bind(this) 
        document.addEventListener('aerisTheme', this.aerisThemeListener);
        
    },
    destroyed: function() {
    	document.removeEventListener('formaterResetEvent', this.resetEventListener);
    	this.resetEventListener = null;
    	document.removeEventListener('formaterSearchEvent', this.searchEventListener);
      ...
      methods:{
		 ...
		 ensureTheme: function() {
		  	if ((this.$el) && (this.$el.querySelector)) {
		  		...
		  		this.$el.querySelector(".formater-select select").style.backgroundColor = color3;
		  	}
		 },
      }
